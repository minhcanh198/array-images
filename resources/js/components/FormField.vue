...
export default {
  ...
  methods: {
    ...
    deleteImage(index) {
      if (confirm('Regardless of updating this resource, once you delete this image, you cannot restore it. Are you sure?')) {
        axios.delete('/nova-vendor/array-images/delete?image=' + this.images[index].name);
